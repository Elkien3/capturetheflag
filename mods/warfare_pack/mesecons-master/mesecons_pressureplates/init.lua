...
mesecon.register_pressure_plate(
	...
	mesecon.register_pressure_plate(
	"mesecons_pressureplates:pressure_plate_hidden",
	"Hidden Pressure Plate",
	{"jeija_pressure_plate_grass.png","jeija_pressure_plate_grass.png","jeija_pressure_plate_stone_off_edges.png"},
	{"jeija_pressure_plate_grass.png","jeija_pressure_plate_grass.png","jeija_pressure_plate_stone_on_edges.png"},
